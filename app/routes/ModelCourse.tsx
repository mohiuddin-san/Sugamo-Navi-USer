...
巣鴨駅すぐの老舗和菓子店【千成もなか本舗】店名由来は豊臣秀吉の馬印「千成瓢箪（ひょうたん）」、縁起を込めた最中が看板商品です。名物はひょうたん形の最中（五色あん）と、人気のあんバターどら焼き。あんバターどら焼きはブラックペッパーと合わせていただくのもオススメ。“和風パンケーキ”（どら焼きの皮だけ）も評判。`, image: "/src/step-12.jpg"
      ...
      },
      {
        ...
        stops: [
          { id: 1, title: "もとこ", description: `わらび餅もとこ　（わらび餅ミルクティー）
巣鴨の実力派和スイーツ店 【わらび餅もとこ】口に入れた瞬間、とろけるような“もっちり × つるん”の食感がやみつきに。定番の三温糖・黒糖・抹茶・紫芋に加え、季節限定のわらび餅も人気。わらび餅ミルクティー もここ発祥と言われてて、スイーツとドリンクの融合が楽しめる一杯。`, image: "/src/stop-4-1.png" },
          { id: 2, title: "雷神堂", description: `<p>とげぬき地蔵尊 高岩寺</p><p>巣鴨といえば「とげぬき地蔵尊」こと【高岩寺】。 病気平癒・延命にご利益があるとされ、江戸時代から多くの人に信仰されてきたお寺です。 境内で人気なのは「洗い観音」。 自分の体の悪い部分と同じ場所を洗うと治るといわれ、いつも行列ができるほど。</p>`, image: "/src/stop-4-2.png" },
          {
            id: 3, title: "みずの", description: `雷神堂　（お煎餅）
巣鴨地蔵通り入口すぐの 手焼きせんべい専門店 【雷神堂 】薄焼き・厚焼きをはじめ、常時100種類以上のお煎餅がずらり。アイシングでデコられたデコ煎はお土産にも。店頭では食べ歩き用の割り煎が販売されています。`, image: "/src/stop-4-3.png"
          },
          { id: 4, title: "ブタまんず", description: `ブタまんず
巣鴨の路地裏にひっそり佇む 豚まん専門店 【ブタまんズ 】しっとりふわふわな生地と、台湾仕込みのジューシーな肉餡が自慢。定番の豚まんだけでなく、黒ごまあんまんやカレー豚まんなど “変わり種” も楽しめるよ。テイクアウト専門だけど店先のベンチでできたてをほおばるのも至福のひととき。`, image: "/src/stop-4-4.png" },
          { id: 5, title: "まる天", description: `まる天
店頭で頬張る方多数の練り物屋さんの名店【まる天 巣鴨店】三重・伊勢発の“揚げ蒲鉾（磯揚げ）”専門店。看板の「たこ棒」や「じゃがバター天」が人気！揚げたてはふわっと軽くて、食べ歩きにもぴったり。甘味のあとに、ちょっとした塩気と魚の旨みを楽しむならここへ。`, image: "/src/stop-4-5.png" },
          {
            id: 6, title: "んいも", description: `んいも（食べ歩き、お土産）
こだわりの壺焼き芋の名店【んいも】宮古島出身の店主が営む小さな壺焼き芋屋さん。巨大な壺でじっくり焼き上げることで、中はとろ〜り、外は香ばしく甘さがぎゅっと凝縮された味わいに。看板メニューは「雪塩つぼ焼き芋」やプレミアムな品種芋“森の絹”など。時期によってお芋の品種も変わるから、訪れるたびに違う表情を楽しんで。  お土産にもオススメ。`, image: "/src/stop-4-6.png"
          }
        ]
      }
    ],
