    ...
    <div className="min-h-screen">
      ...
      <div className="relative border-2 border-black rounded-[30px]" style={{ marginLeft: isMobile ? fsm(20) : fs(90), marginRight: isMobile ? fsm(20) : fs(90), paddingTop: isMobile ? fsm(61) : fs(25) }}>
        ...
        <div className="flex justify-between" style={{ height: isMobile ? fsm(61) : fs(68), paddingLeft: isMobile ? fsm(20) : fs(23), paddingRight: isMobile ? fsm(20) : fs(23) }}>
          <button onClick={handlePrevM} className="text-3xl">
            ←
          </button>
          <button onClick={handleNextM} className="text-3xl">
            →
          </button>
        </div>
      </div>
          ...
          <div className="min-h-screen" style={{ marginTop: isMobile ? fsm(33) : fs(33),paddingBottom: isMobile ? fsm(33) : fs(33) }}>
            <div className="mx-auto flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-2/3" style={{paddingRight: isMobile? fsm(0): fs(36)}}>
                <p className="w-full text-black text-star leading-loose font-cairo font-normal" style={{ fontSize: isMobile ? fsm(16) : fs(16),paddingLeft: isMobile? fsm(0): fs(28),paddingTop: isMobile? fsm(0): fs(10)}}>
...
歴史的なお寺を巡り、おいしいものを味わい、活気あふれる商店街で買い物を楽しむ。このコースは、巣鴨の魅力をぎゅっと凝縮した、初めての方にもリピーターにもおすすめのコースです。</p>
              ...
              <div className="w-[2px] bg-black h-auto" style={{marginRight: isMobile ? fsm(0) : fs(36), marginBottom:isMobile? fsm(0): fs(10)}}></div>

              <div className="w-full md:w-1/3 flex flex-col items-center">
                <div className="text-start mb-8 w-full">
                  <h2 className="text-start font-cousine font-bold italic text-black" style={{ fontSize: isMobile ? fsm(31) : fs(31) }}>START!</h2>
                </div>
              ...
              {!isMobile && (
                <div className="mx-auto h-full" style={{ marginTop: fs(73)  }}>
                  <img src="./src/union.svg" alt="Description"  />
      ...
      <div
        className="relative "
        style={{
          marginTop: isMobile ? fsm(53) : fs(90),
      ...
      >
        <div className="border-2 border-black rounded-[10px] overflow-visible relative" style={{ paddingTop: isMobile ? fsm(76) : fs(76) }}>
          <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 bg-white text-center font-bold italic font-cousine inline-block text-wrap" style={{ paddingLeft: isMobile ? fsm(0) : fs(14), paddingRight: isMobile ? fsm(0) : fs(14), fontSize: autoSize(31) }}>
            COURSE SHOPS
          </div>
