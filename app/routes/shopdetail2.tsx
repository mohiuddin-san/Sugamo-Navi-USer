...
//     return [shop.imageUrl, ...(shop.other_images || [])].filter(Boolean);
//   })();
...
//               })()
//             ) : (
//               <img src={shop.imageUrl} alt={shop.title} className="w-full h-full object-cover" />
//             )}
//           </div>
...
//                   <div
//                     key={index}
//                     className={`flex-shrink-0 cursor-pointer border-2 ${currentIndex % allImages.length === index ? 'border-[#ED4548]' : 'border-transparent'} rounded overflow-hidden`}
//                     style={{ width: fsm(117), height: fsm(88) }}
